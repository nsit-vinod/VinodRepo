package com.ipark.rest.webservices.helloworld;
...
public class HelloWorldController {
	...
	@GetMapping(path = "/hello-world-internationalization-withoutheader")
	public String helloWorldInternationalizationWithoutHeader() {
